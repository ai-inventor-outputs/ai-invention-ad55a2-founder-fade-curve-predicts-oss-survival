...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/prompts/1_create_idea/round_1/1_review_hypo.md` — 2 prompts
- **2. test_idea** — `invention_loop`
  ...
  - round_2
    ...
    - `2_gen_plan/` — 2 task(s)
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_dataset_1.md` — 4 prompts
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 4 prompts
    - `3_gen_art/` — 2 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_dataset_1.md` — 20 prompts
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 4 task(s)
    ...
    - `chat/prompts/3_report_results/1_gen_viz/gen_viz_4.md` — 4 prompts
  - `2_gen_demo_art/` — 3 task(s)
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_dataset_1.md` — 7 prompts
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_dataset_2.md` — 8 prompts
