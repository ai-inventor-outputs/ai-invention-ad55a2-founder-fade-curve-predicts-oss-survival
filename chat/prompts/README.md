...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 17 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 5 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 20 prompts
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 12 prompts
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 26 prompts
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_research_1.md` — 12 prompts
    - `chat/prompts/2_test_idea/round_1/4_gen_paper_text.md` — 22 prompts
  ...
  - round_2
    ...
    - `2_gen_plan/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_evaluation_1.md` — 14 prompts
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 24 prompts
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_research_1.md` — 36 prompts
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 10 prompts
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 9 prompts
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_research_1.md` — 3 prompts
    - `chat/prompts/2_test_idea/round_2/4_gen_paper_text.md` — 6 prompts
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 3 task(s)
    - `chat/prompts/3_report_results/1_gen_viz/gen_viz_1.md` — 6 prompts
